          ...
          child: filteredContacts.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final originalIndex = widget.contacts.indexOf(userName) + 1; // Fix index display

                    return ListTile(
                      selected: isSelected,
                      selectedTileColor: AppColors.primary.withAlpha(50),
                      leading: GestureDetector(
                        onTap: () => widget.isSelectionMode ? widget.toggleSelection(userName, false) : widget.showUserMenu(userName, false),
                        child: CircleAvatar(
                          backgroundColor: isSelected ? AppColors.primary : Colors.blueAccent.withAlpha(50),
                          child: isSelected ? const Icon(Icons.check, color: Colors.white) : Text('$originalIndex', style: const TextStyle(color: Colors.white)),
                        ),
                      ),
